package app.findeck.mobile.ui.settings
        ...
        models.sortedWith(
            ...
            add(
                RuntimeSelectionOption(
                    ...
                    detail = runtimeModelDetailLabel(model),
                )
            )
        }
    }
        ...
        orderedEfforts.forEach { effort ->
            add(
                RuntimeSelectionOption(
                    ...
                    detail = runtimeReasoningDetailLabel(effort, supportedEfforts[effort]),
                )
            )
        }
    }
...
@Composable
private fun runtimeReasoningDetailLabel(
    value: String?,
    ...
    else -> fallbackDetail?.takeIf { it.isNotBlank() } ?: value.orEmpty()
}

@Composable
private fun runtimeModelDetailLabel(model: RuntimeModelDescriptor): String {
